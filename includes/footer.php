<footer class="footer">
			...
			<div class="w-100 mt-5 border-top py-5">
	          ...
	          <div class="col-md-6 col-lg-8">
	            ...
	            <p class="copyright mb-0"><!-- Link back to Iitoetech can't be removed. Template is licensed under CC BY 3.0. -->
	  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://chebarbartiko.com" target="_blank">Titodetech.com</a>
	  <!-- Link back to Titodetech can't be removed. Template is licensed under CC BY 3.0. --></p>
	          </div>
